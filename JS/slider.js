document.addEventListener('DOMContentLoaded', () => {
    const sections = document.querySelectorAll('.project-container, .team-container'); // Select all relevant sections
    ...
    sections.forEach(section => {
        ...
        const scrollAmount = 600 // Adjust the scroll amount per click
